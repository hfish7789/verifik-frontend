...
export const appRoutes: Route[] = [
    ...
    },
    {
        ...
        {
            path: 'settings',
            loadChildren: () => import('app/modules/dashboard/settings/settings.module').then(m => m.SettingsModule)
        },
        {
            path: 'quick-search',
            loadChildren: () => import('app/modules/online-postman/online-postman.module').then(m => m.OnlinePostmanModule)
        }
    ]
    },
];